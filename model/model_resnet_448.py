...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.in_channel_0 = 32
        self.in_channel = 64

        self.groups = groups
        self.width_per_group = width_per_group

        self.conv0 = nn.Conv2d(3, self.in_channel_0, kernel_size=7, stride=2,
                               padding=3, bias=False)
        self.bn0 = nn.BatchNorm2d(self.in_channel_0)
        self.relu = nn.ReLU(inplace=True)

        self.conv1 = nn.Conv2d(self.in_channel_0, self.in_channel, kernel_size=7, stride=2,
                               padding=3, bias=False)
